...
class App(tk.Frame):
    ...
    def cells_setting(self):
        ...
        #
        self.cells = [[[] for y in range(self.cols)] for y in range(self.rows)]
        self.lstMoveGroup = []
        #
        self.btnMoveUp = [0 for x in range(self.cols)]
        self.frmCell = [[0 for x in range(self.cols)] for y in range(self.rows)]
        self.btnUp=  [[0 for x in range(self.cols)] for y in range(self.rows)] 
        self.btnLeft= [[0 for x in range(self.cols)] for y in range(self.rows)]
        self.btnRight = [[0 for x in range(self.cols)] for y in range(self.rows)]
        self.btnDown = [[0 for x in range(self.cols)] for y in range(self.rows)]
        self.btnCenter = [[0 for x in range(self.cols)] for y in range(self.rows)]
    ...
    def getCells(self):
        self.cells = [[[] for x in range(self.cols)] for y in range(self.rows)]
        for i in range(self.rows):
            for j in range(self.cols):
    ...
    def getMovableGroup(self):
        ...
        for i in range(self.rows):
            ...
            for j in range(self.cols):
                ...
                if self.cells[i][j][6] == True: # CanMove
                    tmpList.append(j)
                else:
                    cells = []
